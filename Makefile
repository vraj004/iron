...
OBJECTS = $(OBJECT_DIR)/advection_equation_routines.o \
	...
	$(OBJECT_DIR)/reaction_diffusion_finite_elasticity_routines.o \
...
$(OBJECT_DIR)/reaction_diffusion_finite_elasticity_routines.o	:	$(SOURCE_DIR)/reaction_diffusion_finite_elasticity_routines.f90 \
	$(OBJECT_DIR)/base_routines.o \
	$(OBJECT_DIR)/basis_routines.o \
	$(OBJECT_DIR)/constants.o \
	$(OBJECT_DIR)/control_loop_routines.o \
