...
MODULE PROBLEM_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_REACTION_DIFFUSION_FINITE_ELASTICITY_TYPE=9
  !Problem subtypes
...
!!TODO: We don't really have two problem types here? Maybe a different type with nonlinear boundary conditions???
  ...
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_REACTION_DIFFUSION_ELASTICITY_SUBTYPE=152
  INTEGER(INTG), PARAMETER :: PROBLEM_STRANG_REAC_DIFF_GROWTH_ELASTIC_SUBTYPE=153
